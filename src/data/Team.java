...
public class Team {
	...
	public static void createteams() {
		...
		Player p2 = new Player("2",30, 50, 40, 70, 60, 2, DEF, default_x_defenseur1_bleu, default_y_defenseur1_bleu);
		Player p3 = new Player("3",20, 40, 40, 70, 60, 3, DEF, default_x_defenseur2_bleu, default_y_defenseur2_bleu);
		Player p4 = new Player("4",30, 30, 40, 70, 70, 4, DEF, default_x_defenseur3_bleu, default_y_defenseur3_bleu);
		Player p5 = new Player("5",30, 40, 40, 70, 60, 5, DEF, default_x_defenseur4_bleu, default_y_defenseur4_bleu);
		...
		Player p10 = new Player("10",80, 80, 50, 40, 80, 10, ATT, default_x_attaquant1_bleu, default_y_attaquant1_bleu);
		Player p11 = new Player("11",100, 90, 100, 50, 100, 11, ATT, default_x_attaquant2_bleu, default_y_attaquant2_bleu);
		...
		Player p21 = new Player("12",40, 50, 30, 40, 60, 11, DEF, default_x_defenseur1_rouge, default_y_defenseur1_rouge);
		Player p22 = new Player("13",30, 45, 40, 30, 65, 10, DEF, default_x_defenseur2_rouge, default_y_defenseur2_rouge);
		Player p23 = new Player("14",35, 40, 50, 45, 70, 9, DEF, default_x_defenseur3_rouge, default_y_defenseur3_rouge);
		Player p24 = new Player("15",45, 40, 45, 35, 70, 8, DEF, default_x_defenseur4_rouge, default_y_defenseur4_rouge);

		Player p25 = new Player("16",60, 30, 60, 80, 0, 7, MID, default_x_milieu1_rouge, default_y_milieu1_rouge);
		Player p26 = new Player("17",65, 40, 50, 85, 0, 6, MID, default_x_milieu2_rouge, default_y_milieu2_rouge);
		Player p27 = new Player("18",70, 45, 65, 90, 0, 5, MID, default_x_milieu3_rouge, default_y_milieu3_rouge);
		Player p28 = new Player("19",75, 50, 55, 70, 0, 4, MID, default_x_milieu4_rouge, default_y_milieu4_rouge);

		Player p29 = new Player("20",90, 85, 85, 55, 90, 3, ATT, default_x_attaquant1_rouge, default_y_attaquant1_rouge);
		Player p210 = new Player("21",95, 90, 80, 50, 100, 2, ATT, default_x_attaquant2_rouge, default_y_attaquant2_rouge);

		Player p211 = new Player("22",50, 60, 30, 90, 90, 1, GOAL, default_x_gardien_rouge, default_y_gardien_rouge);
